    ...
    >
      ...
      <div className="flex flex-col items-start gap-4">
        <div className="flex-1 space-y-4">
          <div className="bg-blue400 inline-flex rounded px-3 py-1 text-[10px] font-bold text-white">
            MASCOT {num}
          </div>
          ...
          <div className="space-y-1">
            ...
            <li className="flex gap-1">
              {favorites.map((favorite, i) => (
                <p
                  key={i}
                  className="bg-blue300 rounded-md px-2 py-0.5 text-[12px] font-semibold tracking-tight"
                >
                  {favorite}
                </p>
              ))}
